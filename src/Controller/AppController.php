...
class AppController extends Controller
{
    ...
    public function beforeRender(EventInterface $event) {
        ...
        $this->set(compact('globalContents'));

        //Load global keys from ContentImages
        $globalContentImages = $this
            ->fetchTable('ContentImages')
            ->find('list', [
                'keyField' => 'hint',
        ...
        $this->set(compact('globalContentImages'));
